    ...
    var demo = function () {
        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                {
                    field: 'fullValueWithOutTaxValue',
                ...
                },
            {
                ...
                template: function (data) {
                    return '\<a  href ="/Invoice/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.name + ' ">\
                        ...
                        <a href ="/Invoice/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
