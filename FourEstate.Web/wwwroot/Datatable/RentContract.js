...
var KTDatatableAutoColumnHideDemo = function () {
    ...
    var demo = function () {
        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'RentContract/GetRentContractData',
                    },
                },
                pageSize: 10,
                saveState: false,
...

            {
                ...
                template: function (data) {
                    ...
                    button = button + '\<a  href ="/SaleContract/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.name + ' ">\
                        ...
                        <a href ="/SaleContract/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
 ...
 <a class="PopUp btn btn-sm btn-clean btn-icon mr-2" href="/SaleContract/GetLog/' + data.id + '">\
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
        ...
        <path d="M18,7 C19.1045695,7 20,6.1045695 20,5 C20,3.8954305 19.1045695,3 18,3 C16.8954305,3 16,3.8954305 16,5 C16,6.1045695 16.8954305,7 18,7 Z M18,9 C15.790861,9 14,7.209139 14,5 C14,2.790861 15.790861,1 18,1 C20.209139,1 22,2.790861 22,5 C22,7.209139 20.209139,9 18,9 Z" fill="#000000" fill-rule="nonzero" />\
                    ...
                    if (data.status == "Pending") {
                        return button + '\<a href="/SaleContract/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Approved">\
                    ...
                    <a href="/SaleContract/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Reject">\
                    ...
                    if (data.status == "Rejected") {
                        return button = button + '\<a href="/SaleContract/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Approved">\
                              <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Done-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                            <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                            <rect x="0" y="0" width="24" height="24" />\
                           <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
                        ...
                        return button = button + '\<a href="/SaleContract/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Reject">\
                           <span class="svg-icon svg-icon-danger svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Error-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                            <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                            <rect x="0" y="0" width="24" height="24" />\
                            <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
...
var KTDatatableAutoColumnHideDemo = function () {
    ...
    var demo = function () {
        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            {
                field: 'dateTimeStartRent',
                title: 'تاريخ البداية',
                width: '70'
            },
            {
                field: 'dateTimeEndRent',
                title: 'تاريخ النهاية',
                width: '70'
            },
            {
...

            {
                ...
                template: function (data) {
                    ...
                    button = button + '\<a  href ="/RentContract/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.name + ' ">\
                            <span class="svg-icon svg-icon-warning svg-icon-md">\
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                        <rect x="0" y="0" width="24" height="24"/>\
                        ...
                        <a href ="/RentContract/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
                            <span class="svg-icon svg-icon-danger svg-icon-danger svg-icon-md">\
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                        <rect x="0" y="0" width="24" height="24"/>\
 ...
 <a class="PopUp btn btn-sm btn-clean btn-icon mr-2" href="/RentContract/GetLog/' + data.id + '">\
                        <span class="svg-icon svg-icon-primary svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
        <rect x="0" y="0" width="24" height="24" />\
        <rect fill="#000000" opacity="0.3" x="5" y="8" width="2" height="8" rx="1" />\
        ...
        <path d="M18,7 C19.1045695,7 20,6.1045695 20,5 C20,3.8954305 19.1045695,3 18,3 C16.8954305,3 16,3.8954305 16,5 C16,6.1045695 16.8954305,7 18,7 Z M18,9 C15.790861,9 14,7.209139 14,5 C14,2.790861 15.790861,1 18,1 C20.209139,1 22,2.790861 22,5 C22,7.209139 20.209139,9 18,9 Z" fill="#000000" fill-rule="nonzero" />\
                    ...
                    if (data.status == "Pending") {
                        return button + '\<a href="/RentContract/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Approved">\
                              <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Done-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                            <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                            <rect x="0" y="0" width="24" height="24" />\
                           <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
                    ...
                    <a href="/RentContract/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Reject">\
                           <span class="svg-icon svg-icon-danger svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Error-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                            <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                            <rect x="0" y="0" width="24" height="24" />\
                            <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
                    ...
                    if (data.status == "Rejected") {
                        return button = button + '\<a href="/RentContract/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Approved">\
                              <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Done-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                            <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                            <rect x="0" y="0" width="24" height="24" />\
                           <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
                        ...
                        return button = button + '\<a href="/RentContract/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Reject">\
                           <span class="svg-icon svg-icon-danger svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Error-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                            <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                            <rect x="0" y="0" width="24" height="24" />\
                            <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
