...

{
    public class ContractController :BaseController
    {
        ...
        public ContractController(IContractService contractService)/*, ICustomerService customerService, IRealEstateService realEstateService)/*, IUserSer*//*vice userService) : base(userService)*/
        {
